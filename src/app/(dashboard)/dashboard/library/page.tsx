...
const READING_CONTENT: ReadingContent[] = [
  ...
  // Environmental
  {
    ...
    title: "How Nature Benefits Mental Health",
    description: "APA research on how spending time in nature reduces stress, anxiety, and improves well-being.",
    source: "American Psychological Association",
    sourceUrl: "https://www.apa.org/monitor/2020/04/nurtured-nature",
    readingTime: 10,
    difficulty: "beginner",
    xpReward: 20,
    premiumOnly: false,
  },
  {
    ...
    description: "Marie Kondo's method for decluttering and organizing your living space for better mental clarity.",
    source: "KonMari",
    sourceUrl: "https://konmari.com/about-the-konmari-method/",
    readingTime: 8,
    difficulty: "beginner",
    xpReward: 20,
    premiumOnly: false,
  },
  {
    ...
    description: "National Geographic's guide to reducing your environmental footprint and living more sustainably.",
    source: "National Geographic",
    sourceUrl: "https://www.nationalgeographic.com/environment/article/sustainable-living-guide",
    readingTime: 12,
    difficulty: "beginner",
    xpReward: 25,
    premiumOnly: false,
  },
  {
    ...
    description: "NASA research on houseplants that naturally filter toxins and improve indoor air quality.",
    source: "NASA",
  ...
  },
  {
    id: "23",
    pillar: "environmental",
    title: "Creating an Ergonomic Workspace",
    description: "OSHA guidelines for setting up your desk and workspace to prevent strain and boost productivity.",
    source: "OSHA",
  ...
  },
  {
    ...
    description: "Scientific research on how immersing yourself in nature improves immune function and reduces cortisol.",
    source: "Time Magazine",
    sourceUrl: "https://time.com/5259602/japanese-forest-bathing/",
    readingTime: 8,
    difficulty: "beginner",
    xpReward: 20,
    premiumOnly: false,
  },
  {
    id: "25",
    pillar: "environmental",
    title: "Reducing Digital Clutter for Mental Clarity",
    description: "How organizing your digital life—emails, files, and notifications—can reduce stress and improve focus.",
    source: "Harvard Business Review",
    sourceUrl: "https://hbr.org/2019/03/digital-minimalism-on-living-better-with-less-technology",
    readingTime: 12,
    difficulty: "intermediate",
    xpReward: 25,
    premiumOnly: true,
  ...
  return (
    <div className="space-y-8 w-full max-w-full overflow-x-hidden">
      ...
      <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
        <Filter className="w-4 h-4 text-white/40 flex-shrink-0 mt-1" />

...
const HABIT_TEMPLATES = [
  { name: "30-minute workout", icon: Dumbbell, xp: 20 },
  { name: "8 hours of sleep", icon: Moon, xp: 15 },
  { name: "Drink 8 glasses of water", icon: Droplets, xp: 10 },
  { name: "Eat 5 servings of vegetables", icon: Apple, xp: 15 },
  { name: "10,000 steps", icon: Target, xp: 15 },
];
...
export default function PhysicalPage() {
  ...
  const progress = physicalHabits.length > 0
    ? Math.round((completedToday / physicalHabits.length) * 100)
    : 0;
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-white/60 mt-2">
            Build strength, improve sleep, and nourish your body
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <GlassCard className="flex items-center gap-6">
          <ProgressRing progress={progress} color="physical" />
          <div>
            <div className="text-2xl font-bold text-white">
              {completedToday}/{physicalHabits.length}
            </div>
        ...
        <GlassCard>
          <div className="text-white/60 text-sm mb-1">Weekly Streak</div>
      ...
      <GlassCard>
        ...
        {physicalHabits.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-white/60 mb-2">No physical habits yet</p>
            <p className="text-white/40 text-sm mb-6">
              Start with one of our templates or create your own
            </p>
            <GlassButton variant="primary" onClick={() => setShowAddModal(true)}>
              <Plus className="w-4 h-4 mr-1" />
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <GlassCard>
              <h2 className="text-xl font-semibold text-white mb-6">Add Physical Habit</h2>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {HABIT_TEMPLATES.map((template) => (
                    ...
                    >
                      <div className="w-10 h-10 rounded-lg bg-gradient-physical flex items-center justify-center">
